...
(function(){
    /*
     * Creating List controller and attaching it to the main companyFacts module
     */
    angular
        .module("companyFacts")
    ...
    function ListController(quizMetrics, DataService){
        ...
        vm.data = DataService.companiesData; // Controller reference to the company info created in the factory
        vm.activeCompany = {}; // will be used in the view to hold the data of currently active company
        vm.changeActiveCompany = changeActiveCompany; // reference to a named function below
        ...
        function changeActiveCompany(index){
            // simple function to attach the data of the company clicked on to 
            // the active company object
            vm.activeCompany = index;
        }
